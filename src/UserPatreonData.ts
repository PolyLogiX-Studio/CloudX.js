import { PatreonSnapshotJSON, PatreonSnapshot } from "./PatreonSnapshot";
...
export class UserPatreonData {
	...
	constructor($b: UserPatreonDataJSON = {} as UserPatreonDataJSON) {
		this.Email = $b.email;
...
export interface UserPatreonDataJSON {
	email: string;
