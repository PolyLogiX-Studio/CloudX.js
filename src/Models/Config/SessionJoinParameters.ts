...
export class SessionJoinParameters {
  ...
  constructor($b: SessionJoinParametersJSON = {} as SessionJoinParametersJSON) {
    this.URL = ($b.url as any) instanceof Uri
  ...
  toJSON(): SessionJoinParametersJSON {
    return {
...
export interface SessionJoinParametersJSON {
  url: string
  sessionId: string
  lanOnly: boolean
