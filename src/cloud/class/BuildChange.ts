...
export class BuildChange {
	...
	constructor($b: IBuildChange = {} as IBuildChange) {
		...
		this.Contributors =
			$b.contributors instanceof List
				? $b.contributors
				: List.ToListAs($b.contributors, BuildUser);
		this.AffectedPlatforms =
			$b.affectedPlatforms instanceof Set
				? $b.affectedPlatforms
				: new Set($b.affectedPlatforms);
		this.ExcludedPublishingPlatforms =
			$b.excludedPublishingPlatforms instanceof Set
				? $b.excludedPublishingPlatforms
				: new Set($b.excludedPublishingPlatforms);
	}
	toJSON(): IBuildChange {
		return {
