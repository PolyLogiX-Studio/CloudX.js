...
import { BuildReferenceType } from './BuildReferenceType';
import { ConfigReferenceType } from './ConfigReferenceType';
export class BuildChannel {
  public static GenerateChannelId(): string {
    return "CH-" + uuidv4()
  }
  public get IsValid(): boolean {
    return this.ChannelId != null && this.ChannelId.startsWith("CH-") && this.BuildReferenceType != BuildReferenceType.Invalid && this.ConfigReferenceType != ConfigReferenceType.Invalid && !(this.BuildId == null || this.BuildId == "") && !(this.ConfigId == null || this.ConfigId == "");
  }
  /**
  ...
  constructor($b: BuildChannelJSON = {} as BuildChannelJSON) {
...
export interface BuildChannelJSON {
  channelId: string
  ownerId: string
